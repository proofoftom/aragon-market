...
contract Template is TemplateBase {
    ...
    function newInstance() public {
        ...
        bytes32 appId = keccak256(abi.encodePacked(apmNamehash("open"), keccak256("aragon-market")));
        bytes32 votingAppId = apmNamehash("voting");
        bytes32 tokenManagerAppId = apmNamehash("token-manager");

        MarketApp app = MarketApp(dao.newAppInstance(appId, latestVersionAppBase(appId)));
